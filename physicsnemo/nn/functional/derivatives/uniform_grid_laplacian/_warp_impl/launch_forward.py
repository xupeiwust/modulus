...
from ._kernels import (
    _laplacian_1d_order2_kernel,
    _laplacian_1d_order4_kernel,
    _laplacian_2d_order2_kernel,
    _laplacian_2d_order4_kernel,
    _laplacian_3d_order2_kernel,
    _laplacian_3d_order4_kernel,
)
...
def _launch_forward(
    *,
    ...
    """Launch the dimensionality- and order-specific Laplacian kernel."""
    inv_sq = _inverse_spacings(spacing_tuple, power=2)
    _wp_launch(
        kernel=_FORWARD_KERNELS[(field_fp32.ndim, order)],
